...
=== Install seedkeeper-manager from source

Clone the repository:

    $ git clone https://github.com/Toporin/seedkeeper-manager.git
    $ cd seedkeeper-manager
...
For third-party packaging, use the source releases published on Github on the
https://github.com/Toporin/seedkeeper-manager/releases[Releases page].